...
import Pytorch from '../public/assets/skills/torch.png';
...
import Clang from '../public/assets/skills/C.png';
...
const Skills = () => {
  return (
    <div id='skills' className='w-full p-2 py-16'>
      <div className='py-8 max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
        <p className='text-xl tracking-widest uppercase text-[#5651e5]'>
          Skills
        </p>
        <h2 className='py-4'>What I Have Working Experience On</h2>
